            ...
            var r = e('../lib/oop'),
                ...
                u = function (e) {
                    var t = {
                            ...
                            keyword:
                                'const|yield|import|get|set|async|await|break|case|catch|continue|default|delete|do|else|finally|for|if|in|of|instanceof|new|return|switch|throw|try|typeof|let|var|while|with|debugger|__parent__|__count__|escape|unescape|with|__proto__|class|enum|extends|super|export|implements|private|public|interface|package|protected|static|constructor',
                            'storage.type': 'const|let|var|function',
                            'constant.language': 'null|Infinity|NaN|undefined',
                            'support.function': 'alert',
                            'constant.language.boolean': 'true|false'
                        },
                        n = this.createKeywordMapper(t, 'identifier'),
                        r =
                    ...
                    this.$rules = {
                        ...
                        property: [
                            ...
                            { token: 'support.function', regex: 'prototype' },
                            {
                    ...
                    (this.add(
                        ...
                        function (e, t, n, r, i) {
                            if (i == '"' || i == "'") {
                                ...
                                if (
                                    c == u &&
                                    (o(p, 'attribute-value') || o(p, 'string'))
                                )
                                ...
                                var d = !c || c.match(/\s/);
                                if (
                                    (o(p, 'attribute-equals') &&
                                        (d || c == '>')) ||
                                    (o(p, 'decl-attribute-equals') &&
                                        (d || c == '?'))
                                )
                        ...
                        this.add(
                            ...
                            function (e, t, n, r, i) {
                                if (i == '>') {
                                    ...
                                    if (
                                        /^\s*>/.test(
                                            r.getLine(u.row).slice(u.column)
                                        )
                                    )
                                        return;
                                    while (!o(f, 'tag-name')) {
                ...
                function () {
                    ((this.getFoldWidgetRangeBase = this.getFoldWidgetRange),
                        ...
                        (this.getFoldWidget = function (e, t, n) {
                            ...
                            return r
                                ? r
                                : this.xmlFoldMode.getFoldWidget(e, t, n);
                        }),
                        (this.getFoldWidgetRange = function (e, t, n, r) {
                            var i = this.getFoldWidgetRangeBase(e, t, n, r);
                            return i
                                ? i
                                : this.xmlFoldMode.getFoldWidgetRange(e, t, n);
                        }));
                }.call(o.prototype));
        }
    ),
