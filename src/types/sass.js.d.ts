...
declare module 'sass.js/dist/sass.js' {
    ...
    /**
     * Inline source comment modes.
     */
    export enum SassCommentsEnum {
        none = 0,
        default = 1,
    }
    ...
    export type SassImporterCallback = (
        request: SassImporterRequest,
        done: SassImporterDone,
    ) => void;
