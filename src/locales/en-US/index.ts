...
export default {
    ...
    MODULES: {
        NAME: 'Module name',
        NAME_EXAMPLE: 'ex. My shared library',
        PACKAGE: 'Package',
        PACKAGE_EXAMPLE: 'ex. jquery',
        FILES: 'Files',
        FILE: 'File',
        ...
        PLACEHOLDER_JS: 'Start typing JavaScript here ...',
        PLACEHOLDER_CSS: 'Start typing CSS here ...',
        REVERT: 'Cancel changes',
        USED_BY: 'Used by',
        IMPORT: 'Import',
        IMPORTS: 'Imports',
        ...
        URL_PLACEHOLDER:
            'File URL, ex. https://cdn.jsdelivr.net/npm/jquery\\@3.7.1/dist/jquery.min.js',
        REFRESH: 'Refresh from source',
        REFRESH_ALL: 'Refresh imported files',
        COLLAPSE: 'Collapse',
        EXPAND: 'Expand',
        REMOTE: 'Remote file',
        REMOTE_LINK_COPY: 'Remote file: {url} (Click to copy link)',
    },
    SETTINGS: {
    ...
    TOAST: {
        ...
        SETTINGS: {
            ...
            IMPORT_ERROR: 'Import failed: the selected file is not a valid backup or is corrupted.',
            IMPORTED: 'Settings imported',
            LEGACY_IMPORTED: 'Old extension data imported',
            LEGACY_IMPORT_ERROR:
                'Failed to import data from the old extension. The data may be corrupted or incompatible.',
            LEGACY_NOT_FOUND: 'No data found from the old extension',
            RESET: 'All data has been reset to defaults',
        },
        SYNC: {
            DOWNLOAD_ERROR: 'Failed to download settings from the cloud',
            DOWNLOAD_SUCCESS: 'Settings downloaded from the cloud',
            UPLOAD_ERROR: 'Failed to upload settings to the cloud',
            UPLOAD_SUCCESS: 'Settings uploaded to the cloud',
        },
        COPY: {
