...
export default {
    ...
    MODULES: {
        NAME: 'Nom du module',
        NAME_EXAMPLE: 'ex. Ma bibliothèque partagée',
        PACKAGE: 'Paquet',
        PACKAGE_EXAMPLE: 'ex. jquery',
        FILES: 'Fichiers',
        FILE: 'Fichier',
        ADD_JS: 'Ajouter JavaScript',
        ADD_CSS: 'Ajouter CSS',
        REMOVE_FILE: 'Supprimer le fichier',
        TYPE: 'Type',
        EMPTY: 'Aucun module pour le moment',
        PLACEHOLDER_JS: 'Commencer à développer votre JavaScript ici ...',
        PLACEHOLDER_CSS: 'Commencer à développer votre CSS ici ...',
        REVERT: 'Annuler les changements',
        USED_BY: 'Utilisé par',
        IMPORT: 'Importer',
        IMPORTS: 'Imports',
        QUICK_IMPORT: 'Import rapide',
        ...
        URL_PLACEHOLDER:
            'URL du fichier, ex. https://cdn.jsdelivr.net/npm/jquery\\@3.7.1/dist/jquery.min.js',
        REFRESH: 'Actualiser depuis la source',
        REFRESH_ALL: 'Actualiser les fichiers importés',
        COLLAPSE: 'Réduire',
        EXPAND: 'Déployer',
        REMOTE: 'Fichier distant',
        REMOTE_LINK_COPY: 'Fichier distant : {url} (Cliquer pour copier le lien)',
    },
    SETTINGS: {
    ...
    TOAST: {
        ...
        // MODULE_IMPORTED: 'Fichier importé',
        // MODULE_IMPORT_FAILED: "Échec de l'importation",
        // MODULE_REFRESHED: 'Fichier actualisé',
        // MODULE_REFRESH_FAILED: "Échec de l'actualisation",
        ...
        MODULE: {
            ...
            REFRESHED: 'Fichier actualisé',
            REFRESH_FAILED: "Échec de l'actualisation",
            REMOVED: 'Module supprimé',
            UPDATED: 'Module sauvegardé',
        },
        RULE: {
            CREATED: 'Règle créée',
            DISABLED: 'Règle désactivée',
            ENABLED: 'Règle activée',
            REMOVED: 'Règle supprimée',
            UPDATED: 'Règle sauvegardée',
            NOT_FOUND: "La règle n'a pas été trouvée",
        },
        SETTINGS: {
            EXPORTED: 'Paramètres exportés',
            IMPORT_ERROR: "Import échoué : le fichier sélectionné n'est pas une sauvegarde valide",
            IMPORTED: 'Paramètres importés',
            LEGACY_IMPORTED: "Données de l'ancienne extension importées",
            LEGACY_IMPORT_ERROR: "Échec de l'import des données de l'ancienne extension",
            LEGACY_NOT_FOUND: "Aucune donnée trouvée depuis l'ancienne extension",
            RESET: 'Toutes les données ont été réinitialisées',
        },
        SYNC: {
            DOWNLOAD_ERROR: 'Échec du téléchargement des paramètres depuis le cloud',
            DOWNLOAD_SUCCESS: 'Paramètres téléchargés depuis le cloud',
            UPLOAD_ERROR: "Échec de l'envoi des paramètres vers le cloud",
            UPLOAD_SUCCESS: 'Paramètres envoyés vers le cloud',
        },
        COPY: {
            SUCCEEDED: 'Copié dans le presse-papiers',
